...
### What's new
- **Advanced MTGO settings:** operators can edit watched suffixes and filename globs, stability timing, and CardDataSource upload behavior in the Settings window. The audit also adds controls for custom CA bundles and the logging directory.
